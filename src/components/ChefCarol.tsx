  ...
  return (
    <section id="chef-carol" className="py-14 md:py-20 bg-white relative">
      <div className="max-w-[1000px] mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="rounded-3xl bg-[#F7F5EF] p-6 sm:p-10 border-2 border-[#073B4C]/15 shadow-md">
          
          {/* Header */}
          <div className="text-center max-w-2xl mx-auto mb-8">
            <div className="inline-flex items-center gap-1.5 px-3.5 py-1 rounded-full bg-[#DCEFE5] text-[#134E39] text-xs font-black uppercase mb-3 border border-[#166245]/20">
              <Bot className="w-3.5 h-3.5 text-[#166245]" />
              Complemento del Método
            </div>
            
            <p className="text-sm sm:text-base font-extrabold text-[#134E39] mb-1">
            ...
            <p className="text-sm sm:text-base text-[#073B4C]/85 leading-relaxed font-medium">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 mb-8">
            {features.map((feat) => {
              ...
              return (
                <div
                  key={feat.title}
                  className="bg-white rounded-2xl p-4 sm:p-5 border border-[#073B4C]/15 shadow-sm flex items-start gap-3.5"
                >
                  <div className="w-9 h-9 rounded-xl bg-[#DCEFE5] text-[#134E39] flex items-center justify-center shrink-0 mt-0.5 border border-[#166245]/20">
                    <IconComponent className="w-4 h-4" />
                  </div>
                  <div>
                    <h3 className="text-sm font-extrabold text-[#073B4C] mb-1">
                      {feat.title}
                    </h3>
                    <p className="text-xs text-[#073B4C]/85 leading-relaxed font-medium">
                      {feat.description}
                    </p>
                  </div>
                </div>
