    ...
    <section id="oferta" className="py-16 md:py-24 bg-[#F7F5EF] relative scroll-mt-20 sm:scroll-mt-24">
      <div className="max-w-[1200px] mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-2 gap-2.5 sm:gap-6 lg:gap-8 max-w-5xl mx-auto items-stretch">
          ...
          <div className="bg-[#134E39] text-white rounded-2xl sm:rounded-3xl p-3.5 sm:p-7 lg:p-9 border-2 sm:border-3 border-[#2F8F68] shadow-2xl relative flex flex-col justify-between transform sm:-translate-y-1 md:-translate-y-2 ring-4 ring-[#166245]/25">
            
            {/* Top Recommended Badge */}
            <div className="absolute -top-3.5 sm:-top-4 left-1/2 -translate-x-1/2 bg-[#FFD166] text-[#073B4C] text-[9px] sm:text-xs font-black uppercase px-2.5 sm:px-5 py-1 sm:py-1.5 rounded-full tracking-wider sm:tracking-widest shadow-lg flex items-center gap-1 whitespace-nowrap border border-[#FFD166]">
              <Star className="w-2.5 h-2.5 sm:w-3.5 sm:h-3.5 fill-[#073B4C] shrink-0" />
            ...
            <div>
              <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-1 sm:gap-2 mb-2 sm:mb-4 mt-1 sm:mt-2">
                <span className="text-[10px] sm:text-xs font-extrabold tracking-wider text-[#A8DEC8] uppercase">
                  OPCIÓN B
                </span>
                <span className="text-[9px] sm:text-xs font-black px-2 py-0.5 sm:py-1 bg-white/15 text-white border border-white/20 rounded-md sm:rounded-lg self-start sm:self-auto">
                  Organización Total
                </span>
              </div>

              <h3 className="text-base sm:text-2xl font-black text-white tracking-tight mb-1 sm:mb-2 leading-tight">
                Método + Organización Completa
              </h3>

              <p className="text-xs sm:text-sm text-[#DCEFE5] mb-3 sm:mb-6 font-medium leading-snug">
              ...
              <div className="mb-3 sm:mb-6 pb-3 sm:pb-6 border-b border-white/15">
                ...
                <div className="inline-flex items-center gap-1 px-2 py-0.5 sm:px-3 sm:py-1 rounded-md bg-[#FFD166] text-[#073B4C] text-[10px] sm:text-xs font-black border border-[#FFD166] leading-tight">
                  <Zap className="w-3 h-3 sm:w-3.5 sm:h-3.5 fill-[#073B4C] text-[#073B4C] shrink-0" />
              ...
              {/* Includes List */}
              <div className="space-y-2.5 sm:space-y-4 mb-4 sm:mb-8">
                <p className="text-[10px] sm:text-xs uppercase font-extrabold text-[#DCEFE5] tracking-wider">
                ...
                <div className="space-y-1.5 sm:space-y-2.5">
                  <div className="flex items-start gap-1.5 sm:gap-3">
                    ...
                    <span className="text-xs sm:text-sm text-white font-semibold leading-snug">Método Inteligente de Batch Cooking</span>
                  </div>
                  ...
                  <div className="flex items-start gap-1.5 sm:gap-3">
                    ...
                    <span className="text-xs sm:text-sm text-white font-semibold leading-snug">Chef Carol — Agente de IA</span>
                  </div>
                </div>

                <div className="pt-2 sm:pt-3 border-t border-white/15">
                  <p className="text-[10px] sm:text-xs uppercase font-extrabold text-[#FFD166] tracking-wider mb-1.5 sm:mb-2">
                    MÁS LOS 3 BONOS:
                  </p>

                  <div className="space-y-1.5 sm:space-y-2.5">
                    <div className="flex items-start gap-1.5 sm:gap-3 bg-white/10 p-1.5 sm:p-2.5 rounded-lg sm:rounded-xl border border-white/20">
                      <div className="w-4 h-4 sm:w-5 sm:h-5 rounded-full bg-[#FFD166] text-[#073B4C] flex items-center justify-center shrink-0 mt-0.5">
                        <Check className="w-2.5 h-2.5 sm:w-3.5 sm:h-3.5 stroke-[3]" />
                      </div>
                      <span className="text-xs sm:text-sm text-white font-black leading-snug">Sistema de Etiquetado e Inventario</span>
                    </div>
                    ...
                    <div className="flex items-start gap-1.5 sm:gap-3 bg-white/10 p-1.5 sm:p-2.5 rounded-lg sm:rounded-xl border border-white/20">
                      ...
                      <span className="text-xs sm:text-sm text-white font-black leading-snug">Calendario Mensual de Planificación</span>
                    </div>
                    ...
                    <div className="flex items-start gap-1.5 sm:gap-3 bg-white/10 p-1.5 sm:p-2.5 rounded-lg sm:rounded-xl border border-white/20">
                      ...
                      <span className="text-xs sm:text-sm text-white font-black leading-snug">30 Menús Saludables para Todo el Mes</span>
                    </div>
                  </div>
                </div>
              </div>
            ...
            <div className="mt-2">
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="w-full py-2.5 sm:py-4 px-2 sm:px-6 bg-white hover:bg-[#F7F5EF] text-[#134E39] hover:text-[#0E3B2B] text-xs sm:text-base font-black rounded-xl transition-all duration-200 shadow-xl shadow-black/25 flex items-center justify-center gap-1 sm:gap-2 cursor-pointer group transform hover:-translate-y-0.5 text-center border-2 border-white"
              >
                <span className="hidden sm:inline">QUIERO EL MÉTODO + LOS 3 BONOS</span>
                <span className="sm:hidden">MÉTODO + 3 BONOS</span>
                <ArrowRight className="w-3.5 h-3.5 sm:w-4 sm:h-4 text-[#134E39] transition-transform group-hover:translate-x-1 shrink-0" />
              </a>

              <p className="text-[9px] sm:text-[11px] text-center text-[#DCEFE5] mt-2 sm:mt-3 flex items-center justify-center gap-1 font-semibold leading-tight">
                <ShieldCheck className="w-3 h-3 sm:w-3.5 sm:h-3.5 text-[#A8DEC8] shrink-0" />
                <span>Garantía de 7 días [Supuesto]</span>
              </p>
            </div>
          </div>
