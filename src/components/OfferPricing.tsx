          ...
          <div className="bg-white rounded-2xl sm:rounded-3xl p-3.5 sm:p-7 lg:p-9 border-2 sm:border-3 border-[#2F8F68] shadow-xl sm:shadow-2xl relative flex flex-col justify-between transform sm:-translate-y-1 md:-translate-y-2">
            ...
            <div>
              ...
              <div className="space-y-2.5 sm:space-y-4 mb-4 sm:mb-8">
                ...
                <div className="pt-2 sm:pt-3 border-t border-[#073B4C]/10">
                  ...
                  <div className="space-y-1.5 sm:space-y-2.5">
                    <div className="flex items-start gap-1.5 sm:gap-3 bg-[#F7F5EF] p-1.5 sm:p-2.5 rounded-lg sm:rounded-xl border border-[#2F8F68]/20">
                      <div className="w-4 h-4 sm:w-5 sm:h-5 rounded-full bg-[#2F8F68] text-white flex items-center justify-center shrink-0 mt-0.5">
                        <Check className="w-2.5 h-2.5 sm:w-3.5 sm:h-3.5 stroke-[3]" />
                      </div>
                      <span className="text-xs sm:text-sm text-[#073B4C] font-bold leading-snug">Sistema de Etiquetado e Inventario</span>
                    </div>
                    ...
                    <div className="flex items-start gap-1.5 sm:gap-3 bg-[#F7F5EF] p-1.5 sm:p-2.5 rounded-lg sm:rounded-xl border border-[#2F8F68]/20">
                      ...
                      <span className="text-xs sm:text-sm text-[#073B4C] font-bold leading-snug">Calendario Mensual de Planificación</span>
                    </div>
                    ...
                    <div className="flex items-start gap-1.5 sm:gap-3 bg-[#F7F5EF] p-1.5 sm:p-2.5 rounded-lg sm:rounded-xl border border-[#2F8F68]/20">
                      ...
                      <span className="text-xs sm:text-sm text-[#073B4C] font-bold leading-snug">30 Menús Saludables para Todo el Mes</span>
                    </div>
                  </div>
                </div>
              </div>
            ...
            <div className="mt-2">
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="w-full py-2.5 sm:py-4 px-2 sm:px-6 bg-[#2F8F68] hover:bg-[#257353] text-white text-xs sm:text-base font-extrabold rounded-xl transition-all duration-200 shadow-lg shadow-[#2F8F68]/30 flex items-center justify-center gap-1 sm:gap-2 cursor-pointer group transform hover:-translate-y-0.5 text-center"
              >
